 ...
 * <ul>
 *   <li>{@link citrique2.impl.PlantLinkImpl#getLength <em>Length</em>}</li>
 *   <li>{@link citrique2.impl.PlantLinkImpl#getHeightFrom <em>Height From</em>}</li>
 *   <li>{@link citrique2.impl.PlantLinkImpl#getHeightTo <em>Height To</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlantLinkImpl extends PlantObjectImpl implements PlantLink {
	...
	protected EClass eStaticClass() {
		return ctr2Package.Literals.PLANT_LINK;
	}
	...
	public void setLength(float newLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ctr2Package.PLANT_LINK__LENGTH, oldLength, length));
	}
	...
	public void setHeightFrom(float newHeightFrom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ctr2Package.PLANT_LINK__HEIGHT_FROM, oldHeightFrom, heightFrom));
	}
	...
	public void setHeightTo(float newHeightTo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ctr2Package.PLANT_LINK__HEIGHT_TO, oldHeightTo, heightTo));
	}
