 ...
 * <ul>
 *   <li>{@link citrique2.impl.PlantObjectImpl#getPlant <em>Plant</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlantObjectImpl extends CitriqueObjectImpl implements PlantObject {
	...
	protected EClass eStaticClass() {
		return ctr2Package.Literals.PLANT_OBJECT;
	}
		...
		if (plant != null && plant.eIsProxy()) {
			...
			if (plant != oldPlant) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ctr2Package.PLANT_OBJECT__PLANT, oldPlant, plant));
			}
		}
		return plant;
	}
