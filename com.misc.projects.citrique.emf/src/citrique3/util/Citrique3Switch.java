 ...
 * @generated
 */
public class Citrique3Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Citrique3Package.CITRIQUE_OBJECT: {
			...
			case Citrique3Package.CITRIQUE_DOMAIN: {
			...
			case Citrique3Package.PLANT_OBJECT: {
			...
			case Citrique3Package.PLANT_NODE: {
			...
			case Citrique3Package.PLANT_LINK: {
			...
			case Citrique3Package.BUFFER_SILO_LINK: {
			...
			case Citrique3Package.SILO_REACTOR_LINK: {
