 ...
 * <ul>
 *   <li>{@link citrique3.impl.BufferImpl#getSiloLinks <em>Silo Links</em>}</li>
 *   <li>{@link citrique3.impl.BufferImpl#getCapacity <em>Capacity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BufferImpl extends PlantNodeImpl implements Buffer {
	...
	protected EClass eStaticClass() {
		return Citrique3Package.Literals.BUFFER;
	}
	...
	public EList<BufferSiloLink> getSiloLinks() {
		if (siloLinks == null) {
			siloLinks = new EObjectWithInverseResolvingEList<BufferSiloLink>(BufferSiloLink.class, this, Citrique3Package.BUFFER__SILO_LINKS, Citrique3Package.BUFFER_SILO_LINK__BUFFER);
		}
		return siloLinks;
	}
	...
	public void setCapacity(float newCapacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Citrique3Package.BUFFER__CAPACITY, oldCapacity, capacity));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Citrique3Package.BUFFER__SILO_LINKS:
