 ...
 * @generated
 */
public class Citrique3PackageImpl extends EPackageImpl implements Citrique3Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see citrique3.Citrique3Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Citrique3PackageImpl() {
		super(eNS_URI, Citrique3Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Citrique3Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Citrique3Package init() {
		if (isInited) return (Citrique3Package)EPackage.Registry.INSTANCE.getEPackage(Citrique3Package.eNS_URI);

		// Obtain or create and register package
		Citrique3PackageImpl theCitrique3Package = (Citrique3PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Citrique3PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Citrique3PackageImpl());
		...
		theCitrique3Package.createPackageContents();

		// Initialize created meta-data
		theCitrique3Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theCitrique3Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Citrique3Package.eNS_URI, theCitrique3Package);
		return theCitrique3Package;
	}
	 ...
	 * @generated
	 */
	public Citrique3Factory getCitrique3Factory() {
		return (Citrique3Factory)getEFactoryInstance();
	}
