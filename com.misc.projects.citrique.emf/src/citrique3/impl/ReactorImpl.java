 ...
 * <ul>
 *   <li>{@link citrique3.impl.ReactorImpl#getSiloLinks <em>Silo Links</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReactorImpl extends PlantNodeImpl implements Reactor {
	...
	protected EClass eStaticClass() {
		return Citrique3Package.Literals.REACTOR;
	}
	...
	public EList<SiloReactorLink> getSiloLinks() {
		if (siloLinks == null) {
			siloLinks = new EObjectWithInverseResolvingEList<SiloReactorLink>(SiloReactorLink.class, this, Citrique3Package.REACTOR__SILO_LINKS, Citrique3Package.SILO_REACTOR_LINK__REACTOR);
		}
		return siloLinks;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Citrique3Package.REACTOR__SILO_LINKS:
