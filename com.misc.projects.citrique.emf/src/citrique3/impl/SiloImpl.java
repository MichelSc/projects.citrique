 ...
 * <ul>
 *   <li>{@link citrique3.impl.SiloImpl#getBufferLinks <em>Buffer Links</em>}</li>
 *   <li>{@link citrique3.impl.SiloImpl#getReactorLinks <em>Reactor Links</em>}</li>
 *   <li>{@link citrique3.impl.SiloImpl#getCapacity <em>Capacity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SiloImpl extends PlantNodeImpl implements Silo {
	...
	protected EClass eStaticClass() {
		return Citrique3Package.Literals.SILO;
	}
	...
	public EList<BufferSiloLink> getBufferLinks() {
		if (bufferLinks == null) {
			bufferLinks = new EObjectWithInverseResolvingEList<BufferSiloLink>(BufferSiloLink.class, this, Citrique3Package.SILO__BUFFER_LINKS, Citrique3Package.BUFFER_SILO_LINK__SILO);
		}
		return bufferLinks;
	}
	...
	public EList<SiloReactorLink> getReactorLinks() {
		if (reactorLinks == null) {
			reactorLinks = new EObjectWithInverseResolvingEList<SiloReactorLink>(SiloReactorLink.class, this, Citrique3Package.SILO__REACTOR_LINKS, Citrique3Package.SILO_REACTOR_LINK__SILO);
		}
		return reactorLinks;
	}
	...
	public void setCapacity(float newCapacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Citrique3Package.SILO__CAPACITY, oldCapacity, capacity));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Citrique3Package.SILO__CAPACITY:
				return getCapacity();
		}
