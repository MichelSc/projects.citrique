 ...
 * <ul>
 *   <li>{@link citrique.impl.BufferImpl#getSiloLinks <em>Silo Links</em>}</li>
 *   <li>{@link citrique.impl.BufferImpl#getCapacity <em>Capacity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BufferImpl extends PlantNodeImpl implements Buffer {
	...
	protected EClass eStaticClass() {
		return CitriquePackage.Literals.BUFFER;
	}
	...
	public EList<BufferSiloLink> getSiloLinks() {
		if (siloLinks == null) {
			siloLinks = new EObjectWithInverseResolvingEList<BufferSiloLink>(BufferSiloLink.class, this, CitriquePackage.BUFFER__SILO_LINKS, CitriquePackage.BUFFER_SILO_LINK__BUFFER);
		}
		return siloLinks;
	}
	...
	public void setCapacity(float newCapacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CitriquePackage.BUFFER__CAPACITY, oldCapacity, capacity));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CitriquePackage.BUFFER__SILO_LINKS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CitriquePackage.BUFFER__SILO_LINKS:
				return getSiloLinks();
			case CitriquePackage.BUFFER__CAPACITY:
				return getCapacity();
		}
