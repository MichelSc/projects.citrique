...
/**
 * This is the item provider adapter for a {@link citrique3.SiloReactorLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SiloReactorLinkItemProvider extends PlantLinkItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Citrique3Package.Literals.SILO_REACTOR_LINK__SILO,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Citrique3Package.Literals.SILO_REACTOR_LINK__REACTOR,
				 true,
				 false,
				 true,
				 null,
