...
/**
 * This is the item provider adapter for a {@link citrique3.BufferSiloLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BufferSiloLinkItemProvider extends PlantLinkItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Citrique3Package.Literals.BUFFER_SILO_LINK__SILO,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Citrique3Package.Literals.BUFFER_SILO_LINK__BUFFER,
				 true,
				 false,
				 true,
				 null,
