...
/**
 * This is the item provider adapter for a {@link citrique.BufferSiloLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CitriquePackage.Literals.BUFFER_SILO_LINK__SILO,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CitriquePackage.Literals.BUFFER_SILO_LINK__BUFFER,
				 true,
				 false,
				 true,
				 null,
